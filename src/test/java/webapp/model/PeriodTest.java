...
public class PeriodTest extends Assert {
    ...
    @Test
    public void testEqualsStartDateNullOtherNotNull() {
        Date start = DateUtil.getDate(2020, Calendar.JANUARY);
        Date end = DateUtil.getDate(2021, Calendar.DECEMBER);
        Period period1 = new Period(null, end, "Developer", "Description");
        Period period2 = new Period(start, end, "Developer", "Description");
        assertNotEquals(period1, period2);
    }

    @Test
    public void testEqualsEndDateNullOtherNotNull() {
        Date start = DateUtil.getDate(2020, Calendar.JANUARY);
        Date end = DateUtil.getDate(2021, Calendar.DECEMBER);
        Period period1 = new Period(start, null, "Developer", "Description");
        Period period2 = new Period(start, end, "Developer", "Description");
        assertNotEquals(period1, period2);
    }

    @Test
    public void testEqualsPositionNullOtherNotNull() {
        Date start = DateUtil.getDate(2020, Calendar.JANUARY);
        Date end = DateUtil.getDate(2021, Calendar.DECEMBER);
        Period period1 = new Period(start, end, null, "Description");
        Period period2 = new Period(start, end, "Developer", "Description");
        assertNotEquals(period1, period2);
    }

    @Test
    public void testEqualsContentNullOtherNotNull() {
        Date start = DateUtil.getDate(2020, Calendar.JANUARY);
        Date end = DateUtil.getDate(2021, Calendar.DECEMBER);
        Period period1 = new Period(start, end, "Developer", null);
        Period period2 = new Period(start, end, "Developer", "Description");
        assertNotEquals(period1, period2);
    }
