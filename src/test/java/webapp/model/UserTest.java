...
public class UserTest extends Assert {
    ...
    @Test
    public void testCheckPasswordComplexityNoUpperCaseAndDigits() {
        User user = new User();
        user.setNewPassword("aaaaaaaa");
        String error = user.checkPasswordComplexity();
        assertEquals(User.PASSWORD_NOT_CONTAIN_UPPERCASE_AND_DIGITS, error);
    }

    @Test
    public void testConstructorWithOnlyUsername() {
    ...
    public void testStaticConstants() {
        assertEquals(8, User.MIN_PASSWORD_LENGTH);
        assertNotNull(User.PASSWORD_REQUIREMENTS);
        assertNotNull(User.emailPattern);
        assertNotNull(User.passwordPattern);
    }
}
