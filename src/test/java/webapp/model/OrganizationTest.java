...
public class OrganizationTest extends Assert {
    ...
    public void testEqualsDifferentPeriods() {
        Period period1 = new Period(2020, Calendar.JANUARY, 2021, Calendar.DECEMBER, "Developer", "Desc");
        Period period2 = new Period(2021, Calendar.JANUARY, 2022, Calendar.DECEMBER, "Senior", "Other");
        Organization org1 = new Organization("Company", "http://company.com", period1);
        Organization org2 = new Organization("Company", "http://company.com", period2);
