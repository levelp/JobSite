...
public class LinkTest extends Assert {
    ...
    public void testEqualsNameNullOtherNotNull() {
        Link link1 = new Link(null, "http://test.com");
        Link link2 = new Link("Test", "http://test.com");
        assertNotEquals(link1, link2);
    }

    @Test
    public void testEqualsNameNotNullOtherNull() {
        Link link1 = new Link("Test", "http://test.com");
        Link link2 = new Link(null, "http://test.com");
        assertNotEquals(link1, link2);
    }

    @Test
    public void testEqualsUrlNullOtherNotNull() {
    ...
    @Test
    public void testEqualsUrlNotNullOtherNull() {
        Link link1 = new Link("Test", "http://test.com");
